...
BEGIN
    ...
    insert into evento(id_evento, nombre_evento, fecha_evento, hora_inicio, hora_fin, tipo_evento, ubicacion_evento, dni_cliente)
    values (id_del_evento,nombre_evento, fecha_evento, hora_inicio, hora_fin, tipo_evento, ubicacion_evento, dni);
    
    insert into tipo_contratacion(id_tipo_contratacion,cantidad,fecha_reserva,tipo_servicio,id_evento)
    values (id_de_contratacion,cantidad,fecha_evento,tipo_evento,id_del_evento);
END
// delimiter ;
call insertar(1,'a','a','a','a','a',1,'a','a','a','a','2024-02-14','20:00:00','03:00:00','boda','a');
select * from persona; 
select * from cliente;
select * from evento;
select * from tipo_contratacion;
